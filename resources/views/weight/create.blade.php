                        ...
                        <form method="POST" action="{{isset($weight)?route('weight.update', ['id' => $weight->id]):route('weight.store')}}">
                            ...
                            <div class="form-group mt-2">
                                ...
                                <div class="input-group">
                                    <input type="text" name="value" class="form-control float-input" id="value" placeholder="" value="{{isset($weight)?\App\Helpers\NumberHelper::toFloat($weight->value):old('value')}}">
